...
Благодаря использованию 443 порта и SSL соединения весь трафик сервера выглядит как обычный HTTPS не зависимо от того, что на самом деле он в себе содержит.
## Возможности
...
После успешной сборки проекта, вы можете запустить сервер с командной строки или кликнув два раза по ярлыку
